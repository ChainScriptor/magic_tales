...
export default function ImageReveal({ leftImage, middleImage, rightImage, leftVideo, middleVideo, rightVideo }: ImageRevealProps) {
    ...
    return (
        <motion.div
            ...
            animate="animate"
        >
            {/* Left Video/Image - Lowest z-index */}
            <motion.div
            ...
            {/* Middle Video/Image - Middle z-index */}
            <motion.div
            ...
            {/* Right Video/Image - Highest z-index */}
            <motion.div
                className="absolute w-48 h-48 origin-bottom-right overflow-hidden rounded-xl shadow-lg bg-white"

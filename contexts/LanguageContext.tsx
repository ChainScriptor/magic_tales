...
const translations: Record<Language, Translations> = {
  en: {
    ...
    bookCreation: {
      ...
      phonePrompt: 'And your phone number? So you never lose your account.',
      phoneTerms: 'We\'ll only text book + order updates. Details in our <a href="#" class="underline">Terms & Privacy Policy</a>.',
  ...
  el: {
    ...
    bookCreation: {
      ...
      phonePrompt: 'Και το τηλέφωνό σας; Για να μην χάσετε ποτέ τον λογαριασμό σας.',
      phoneTerms: 'Θα στείλουμε μόνο ενημερώσεις για βιβλία + παραγγελίες. Λεπτομέρειες στους <a href="#" class="underline">Όρους & Πολιτική Απορρήτου</a>.',
